//package com.example.ai.myapplication2.view;
//
...
//
//    private AutoLinearLayout viewGroup;
//
...
//        viewGroup = (AutoLinearLayout) view.findViewById(R.id.viewGroup);
//    }
//
//    /**
//     * 触摸停止计时器，抬起启动计时器
...
////            ImageLoader.getInstance().displayImage(imageUrl, imageView, LoadingImg.option1);
////            KLog.i(imageUrl);
